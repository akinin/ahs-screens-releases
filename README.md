...
Этот репозиторий содержит готовые установочные пакеты AHS Screens.
...
Скачайте стандартный APK AHS Screens из раздела **Releases → Latest**, разрешите установку из выбранного
...
Персонально оформленный APK поставляется отдельно. Обновляйте его только
пакетами с тем же идентификатором приложения и той же цифровой подписью.
