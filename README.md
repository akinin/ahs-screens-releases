...
## Клиент: Debian 12/13 без рабочего стола
...
Режим macOS работает в окне. Настройки клиента позволяют проверить
...
Скачайте APK AHS Screens из раздела **Releases → Latest**, разрешите установку из выбранного
...
Персонально оформленный APK поставляется отдельно.
